...
return (
  <div className="h-[100dvh] overflow-y-scroll overflow-x-hidden px-2 py-4 sm:p-8 bg-[#02141B] text-white pb-[240px] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-cyan-300/35">
